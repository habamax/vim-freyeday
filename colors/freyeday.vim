...
" Last Updated: 17.04.2021 13:22:50
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffAdd guifg=NONE guibg=#eeeeee gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#eeeeee gui=NONE cterm=NONE
  hi DiffText guifg=#ffffff guibg=#8787d7 gui=NONE cterm=NONE
  hi DiffDelete guifg=#d75f5f guibg=#eeeeee gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=231 ctermbg=104 cterm=NONE
...
" Color: color16    #E4E4E4 253
" Color: color17    #EEEEEE 254
